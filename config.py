...
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://opabhik1:opabhik1@cluster0.prsvqax.mongodb.net/?retryWrites=true&w=majority")
...
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 20000)) # Add time in seconds
